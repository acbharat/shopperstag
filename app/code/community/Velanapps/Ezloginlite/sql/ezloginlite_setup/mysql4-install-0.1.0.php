...
$installer->run("
					CREATE TABLE IF NOT EXISTS {$this->getTable('ezloginlite_accounts')} (
					  `account_id` tinyint(4) NOT NULL AUTO_INCREMENT,
					  `account_name` varchar(255) NOT NULL,
					  PRIMARY KEY (`account_id`)
					) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

					INSERT INTO {$this->getTable('ezloginlite_accounts')} (`account_id`, `account_name`) VALUES
					(1, 'Facebook');

					CREATE TABLE IF NOT EXISTS {$this->getTable('ezloginlite_customers')} (
